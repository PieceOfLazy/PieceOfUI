...
public class StripOfTree<MODEL extends IStripOfTreeModelNode> implements IStripOfNode<MODEL> {
    ...
    public StripOfTree(MODEL model) {
        setModel(model);
    }
    ...
    @NonNull
    private final List<IStripOfNode> mNodes = new ArrayList<>();
    ...
    public void beginTransition(@NonNull IStripOfTreeNotify notify, int position, NotifyListener l) {
        ...
        for(IStripOfNode node : mNodes) {
            if(node != null) {
                node.beginTransition(notify, nodePosition, new NotifyListener() {
                    @Override
    ...
    public void commitNotifyChanged() {
        ...
        if(mNotifyParam.mTreeChanged) {
            ...
            switch(mNotifyParam.mState) {
                case CHANGED: {
                    IStripOfNode node = getNode(mNotifyParam.mNodePosition);
                    if(node != null) {
    ...
    public final IStripOfNode getNode(int index) {
    ...
    public final int getNodeIndex(IStripOfNode node) {
    ...
    public final void addNode(IStripOfNode node) {
        if(node == null) {
            return;
        }
    ...
    public final void addNode(int index, IStripOfNode node) {
        if(mNotify != null && isExpandTree()) {
            IStripOfNode tmpNode = getNode(index);
            if(tmpNode == null) {
                addNode(node);
                return;
            } else {
    ...
    public final void removeNode(IStripOfNode node) {
    ...
    public final IStripOfNode removeNode(int index) {
        IStripOfNode node = mNodes.get(index);
        if(node == null) {
            return null;
        }
